...
time_sleep_main_loop = 5 # 3 GA demo,[seconds] sleep time between consecutive reads from the command dir: 0.1 = 100 ms, if 1 sec all PC interactions are difficult
