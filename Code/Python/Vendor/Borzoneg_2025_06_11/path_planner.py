# Wrong way: I created a conda env with python 3.10.12 as Diego (ROS2 requirement), I activated it in terminal and used as interpreter for this project
#            I checked pip was the one for this env
# Right way: I installed this project on top of ROS2 humble (python38), since it needs rclpy (ros2)
# Then I installed following (no requirements file was in the Guglielmo project):
# pip install matplotlib
# pip install roboticstoolbox-python
# pip install "numpy<2"
# pip install pandas
# ModuleNotFoundError: No module named 'rclpy._rclpy_pybind11'
# this error is because the rclpy package in ROS 2 Humble depends on a compiled C extension that is tightly coupled with the Python version and environment used during installation.
# ROS 2 Humble on Windows comes with its own Python installation located in: C:\dev\ros2_humble\Lib\site-packages
# You must use this Python interpreter to run ROS 2 code. Using a Conda or custom Python environment will break compatibility with compiled extensions like _rclpy_pybind11
