...
class SimRobotBackend(ERobot):
    ...
    #MB Full scan livelli verticali, h nr di punti per ogni cerchio
    ...
    # MB Slice v_res nr di punti partendo dall'alto
    ...
    # MB Snake, ampiezza snake to be defined
...
if __name__ == "__main__":
    robot_base = sm.SE3.Rt(np.eye(3), [0, 0, 0])
    ...
    robot.init_plot_env()
    b = robot.add_collision_box((0, 0, 0), 0.5, 0.5, 0.5)
    b = robot.add_collision_sphere((0, 0, 0), 0.5)
    robot.env.hold()
