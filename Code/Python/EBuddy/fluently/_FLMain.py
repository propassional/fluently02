...
# This is for avoiding ImportError: could not load requested Qt binding and console entering the interactive mode
import matplotlib
matplotlib.use("Agg")  # No GUI, just saves plots to files
...
from FLConstants import LINK_TO_COMMAND_IMAGES, SM_COMMAND_IMAGES, YAML_MAIN_PATH, YAML_MAIN_PATH
from FLGUIMain import FLGUIMain
