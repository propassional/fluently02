...
# Check that no Artec Studio instances are opened, if there are any, warn to save SM_JSON_data, then kill them
    ...
    def run(self):
        ...
        while True:
            ...
            if message != "":
                ...
                message = ""
            print(f"run still alive, message {message} nr {index}")
            time.sleep(1)
