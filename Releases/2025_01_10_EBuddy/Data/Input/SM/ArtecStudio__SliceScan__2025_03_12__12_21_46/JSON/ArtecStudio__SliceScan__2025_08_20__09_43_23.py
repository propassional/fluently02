...
# 3) Adjust PathToFile and run this interactive program in pycharm terminal: >python PathToFile\ArtecStudio__SliceScan__2024_09_15__11_43_22.py

# >python D:\Banfi\Github\Fluently\Releases\2025_01_10_EBuddy\Data\Input\SM\ArtecStudio__SliceScan__2024_09_15__11_43_22\JSON\ArtecStudio__SliceScan__2024_09_15__11_43_22.py
import time
import sys
import os
import queue
...
# Global trajectory to be used in most methods
...
path_to_add = os.path.abspath(r'D:\Banfi\Github\Fluently\Code\Python\knowledge-transfer-fleuntly-main')
...
#def TopScanPosDo(message_queue):
...
def SliceScanHomeDo(message_queue):
    return HomeDo(message_queue)
